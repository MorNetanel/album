...
export enum PhotoType{
    LANDSCAPE, WILDLIFE, MACRO, UNDERWATER, ASTROPHOTOGRAPHY, AERIAL,
     SCIENTIFIC, PORTRAITS, WEDDING,
    DOCUMENTARY, SPORTS, FASHION, COMMERCIAL, STREET, EVENT, TRAVEL,
     PET,PRODUCT, FOOD, ARCHITECTURE
